...
const products = Array.from({ length: 48 }, (_, i) => ({
  ...
  brand: "Fear of God",
  price: `Rs. ${(52000 + i * 1000).toLocaleString()}.00`,
  image: `/60-off-female/1 (${i + 1}).jpg`,
}));

export default function Female_60_Off() {
  ...
  return (
    <main className="relative bg-gradient-to-b from-pink-50 to-white text-gray-900">
      {/* --- Hero Section --- */}
      <section className="relative w-full h-[100vh] overflow-hidden">
        <Image
          src="/60-off-female/1 (2).jpg"
          alt="Female Collection Hero"
          fill
          priority
        ...
        <div className="absolute inset-0 bg-black/50 flex flex-col items-center justify-center text-center text-white">
          <h1 className="text-5xl md:text-6xl font-bold drop-shadow-lg">
            Women’s Collection — 60% Off
          </h1>
          <p className="mt-4 text-lg md:text-xl text-gray-200 max-w-2xl">
            Indulge in the elegance of <strong>Fear of God</strong> — now at an
