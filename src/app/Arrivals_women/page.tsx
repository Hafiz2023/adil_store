...
const products = Array.from({ length: 48 }, (_, i) => ({
  ...
  brand: "Fear of God",
  price: `$${(200 + i * 3).toFixed(2)}`, // 💲 Convert to USD-style pricing
  image: `/arrivals-women/1 (${i + 1}).jpg`,
}));

export default function Arrivals_women() {
  ...
  return (
    <main className="bg-gradient-to-b from-pink-50 to-white text-gray-900 min-h-screen">
      {/* --- Hero Section --- */}
      <section className="relative w-full h-[100vh] overflow-hidden">
        <Image
          src="/arrivals-women/1 (1).jpg"
        ...
        <div className="absolute inset-0 bg-black/50 flex flex-col items-center justify-center text-center text-white">
          <h1 className="text-5xl md:text-6xl font-bold drop-shadow-lg">
            New Arrivals — Women’s Collection
          </h1>
          <p className="mt-4 text-lg md:text-xl text-gray-200 max-w-2xl">
            Discover the elegance and power of{" "}
            <strong>Fear of God Essentials</strong> — redefine your wardrobe
            today.
          </p>
        </div>
      </section>
